...
<?php 
  ...
  $insGenerar = new menuController();	
    ...
    $nombre= ($_SESSION['sede'] != "") ? 'SC '.$_SESSION['sede'] : "Sendero Campeones";
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="<?php echo APP_URL; ?>app/views/dist/img/Logos/LogoSC.png" alt="Sendero Campeones Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
